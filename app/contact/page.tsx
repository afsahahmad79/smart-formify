          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <Card>
              <CardContent className="p-6">
                <h3 className="font-semibold text-lg mb-2">How do I get started with Smart Formify?</h3>
                <p className="text-gray-600">
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="font-semibold text-lg mb-2">What types of forms can I create?</h3>
                <p className="text-gray-600">
            ...
            <Card>
              <CardContent className="p-6">
                <h3 className="font-semibold text-lg mb-2">Can I integrate with other tools?</h3>
                <p className="text-gray-600">
